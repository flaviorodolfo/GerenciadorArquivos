...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/Arquivos';
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="container" style="max-width: 600px">
            <form class="mt-5" action="" method="post" autocomplete="off">
                ...
                <button type="submit" class="btn btn-info py-2 px-4""><i class="fa fa-sign-in"></i> Entrar</button>
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="container mt-3">
        <p><h4><b>Enviando Arquivos</b></h4></p>
        <p class="break-word">Pasta de destino: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?></p>
        <hr>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>
                ...
                <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="text-secondary"><i class="fa fa-times-circle"></i> Cancelar</a></b>
            </p>
        </form>
    </div>
    <?php
...
if (isset($_POST['copy']) && !FM_READONLY) {
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post">
            ...
            ?>
            <p class="break-word">Arquivos: <b><?php echo implode('</b>, <b>', $copy_files) ?></b></p><hr>
            <p class="break-word">Pasta de Origem: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?><br>
                <div class="form-inline"><label for="inp_copy_to">Pasta destino:</label>
            ...
            <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="customCheck1">Mover</label>
            </div>
<!--                <label><input type="checkbox" name="move" value="1"> Move</label>-->
            </p>
            <hr>
            <p>
                <button type="submit" class="btn btn-primary"><i class="fa fa-copy"></i> Copiar </button> &nbsp;
                <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="text-secondary"><i class="fa fa-times-circle"></i> Cancelar</a></b>
            </p>
        </form>
    </div>
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="container mt-3">
        <p><h4><b>Copiando</b></h4></p>
        <p class="break-word">
            Pata de origem: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br>
            Pasta destino: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?>
        </p><hr>
        <p>
            <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> Copiar</a></b> &nbsp;
            <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> Mover</a></b> &nbsp;
            <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i> Cancelar</a></b>
        </p>
        <p><i>Selecionar Pasta</i></p>
...
if (isset($_GET['view'])) {
    ...
    <div class="path pt-3">
        ...
        <p class="break-word">
            Path: <?php echo fm_enc(fm_convert_win($file_path)) ?><br>
            Tamanho do arq.: <?php echo fm_get_filesize($filesize) ?><?php if ($filesize >= 1000): ?> (<?php echo sprintf('%s bytes', $filesize) ?>)<?php endif; ?><br>
            Tipo MIME: <?php echo $mime_type ?><br>
            <?php
            // ZIP info
            if ($is_zip && $filenames !== false) {
                ...
                ?>
                Arquivos no zip: <?php echo $total_files ?><br>
                Tamanho total: <?php echo fm_get_filesize($total_uncomp) ?><br>
                Tamanho no arquvio: <?php echo fm_get_filesize($total_comp) ?><br>
                Compressão: <?php echo round(($total_comp / $total_uncomp) * 100) ?>%<br>
                <?php
            }
            // Image info
            if ($is_image) {
        ...
        <p>
            ...
            <b><a class="btn-outline-primary btn-sm btn" href="<?php echo fm_enc($file_url) ?>" target="_blank"><i class="fa fa-external-link-square"></i> Abrir</a></b> &nbsp;
            <?php
            // ZIP actions
            if (!FM_READONLY && $is_zip && $filenames !== false) {
                $zip_name = pathinfo($file_path, PATHINFO_FILENAME);
                ?>
                <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>"><i class="fa fa-check-circle"></i> UnZipar</a></b> &nbsp;
                <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>&amp;tofolder=1" title="UnZip to <?php echo fm_enc($zip_name) ?>"><i class="fa fa-check-circle"></i>
                        UnZipar para Pasta</a></b> &nbsp;
                <?php
            }
            if($is_text && !FM_READONLY) {
                ?>
                <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>" class="edit-file"><i class="fa fa-pencil-square"></i> Editar</a></b> &nbsp;
                <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&env=ace" class="edit-file"><i class="fa fa-pencil-square"></i> Edição avançada.</a></b> &nbsp;
            <?php }
            if($send_mail && !FM_READONLY) {
                ?>
                <b><a class="btn-outline-primary btn-sm btn" href="javascript:mailto('<?php echo urlencode(trim(FM_ROOT_PATH.'/'.FM_PATH)) ?>','<?php echo urlencode($file) ?>')"><i class="fa fa-pencil-square"></i> Email</a></b> &nbsp;
            <?php } ?>
            <b><a class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-chevron-circle-left"></i> Voltar</a></b>
        </p>
        <?php
        if ($is_zip) {
            // ZIP content
...
if (isset($_GET['edit'])) {
    ...
    <div class="path pt-3">
        <div class="mb-3">
            <a title="Cancel" class="btn-outline-primary btn-sm btn" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;view=<?php echo urlencode($file) ?>"><i class="fa fa-reply-all"></i> Cancelar</a>
            ...
            <?php if($is_text) { ?>
                <?php if($isNormalEditor) { ?>
                    <a class="btn-outline-primary btn-sm btn" title="Advanced" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&amp;env=ace"><i class="fa fa-paper-plane"></i> Edição avançada.</a>
                    <button class="btn-outline-primary btn-sm btn" type="button" name="Save" data-url="<?php echo fm_enc($file_url) ?>" onclick="edit_save(this,'nrl')"><i class="fa fa-floppy-o"></i> Salvar</button>
                <?php } else { ?>
                    <a class="btn-outline-primary btn-sm btn" title="Plain Editor" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>"><i class="fa fa-text-height"></i> Editor simples</a>
                    <button class="btn-outline-primary btn-sm btn" type="button" name="Save" data-url="<?php echo fm_enc($file_url) ?>" onclick="edit_save(this,'ace')"><i class="fa fa-floppy-o"></i> Salvar</button>
                <?php } ?>
            <?php } ?>
        </div>
        <?php
    ...
    <div class="py-3 container">
        ...
        <form action="" method="post">
            ...
            <table class="compact-table">
                <tr>
                    <td></td>
                    <td><b>Propietário</b></td>
                    <td><b>Grupo</b></td>
                    <td><b>Outro</b></td>
                </tr>
                <tr>
                    <td style="text-align: right"><b>Leitura</b></td>
                    <td><label><input type="checkbox" name="ur" value="1"<?php echo ($mode & 00400) ? ' checked' : '' ?>></label></td>
                    <td><label><input type="checkbox" name="gr" value="1"<?php echo ($mode & 00040) ? ' checked' : '' ?>></label></td>
                    <td><label><input type="checkbox" name="or" value="1"<?php echo ($mode & 00004) ? ' checked' : '' ?>></label></td>
                </tr>
                <tr>
                    <td style="text-align: right"><b>Escrita</b></td>
                    <td><label><input type="checkbox" name="uw" value="1"<?php echo ($mode & 00200) ? ' checked' : '' ?>></label></td>
                    <td><label><input type="checkbox" name="gw" value="1"<?php echo ($mode & 00020) ? ' checked' : '' ?>></label></td>
                    <td><label><input type="checkbox" name="ow" value="1"<?php echo ($mode & 00002) ? ' checked' : '' ?>></label></td>
                </tr>
                <tr>
                    <td style="text-align: right"><b>Execução</b></td>
            ...
            <p>
                <button type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i> Mudar</button> &nbsp;
                <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="text-secondary"><i class="fa fa-times-circle"></i> Cancelar</a></b>
            </p>
...
<form class="mt-3 mx-3" action="" method="post">
    ...
    <table class="table" id="main-table"><thead><tr>
            ...
            <?php if (!FM_IS_WIN): ?>
                <th style="width:6%">Permições</th>
                <th style="width:10%">Propietário</th><?php endif; ?>
            <th style="width:<?php if (!FM_READONLY): ?>13<?php else: ?>6.5<?php endif; ?>%">Ações</th>
        </tr>
        </thead>
        <?php
        ...
        if (empty($folders) && empty($files)) {
            ...
            <tr><?php if (!FM_READONLY): ?><td class="gray"></td><?php endif; ?><td class="gray" colspan="<?php echo !FM_IS_WIN ? '6' : '4' ?>">
                    Tamanho total: <span title="<?php printf('%s bytes', $all_files_size) ?>"><?php echo fm_get_filesize($all_files_size) ?></span>,
                    arquivos: <?php echo $num_files ?>,
                    pastas: <?php echo $num_folders ?>
                </td></tr>
            <?php
        }
        ?>
    ...
    <?php if (!FM_READONLY): ?>
        <div class="mb-5 row">
            <div class="col-sm-9 offset-sm-3"><a href="#/select-all" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary" onclick="select_all();return false;"><i class="fa fa-check-square"></i> Selecionar tudo</a> &nbsp;
            <a href="#/unselect-all" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary" onclick="unselect_all();return false;"><i class="fa fa-window-close"></i> Remover seleção</a> &nbsp;
            <a href="#/invert-all" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary" onclick="invert_all();return false;"><i class="fa fa-th-list"></i> Inverter seleção</a> &nbsp;
            ...
            <a href="javascript:document.getElementById('a-delete').click();" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary"><i class="fa fa-trash"></i> Deletar </a> &nbsp;
            <input type="submit" class="hidden" name="zip" id="a-zip" value="Zip" onclick="return confirm('Create archive?')">
            <a href="javascript:document.getElementById('a-zip').click();" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary"><i class="fa fa-file-archive-o"></i> Zipar </a> &nbsp;
            <input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
            <a href="javascript:document.getElementById('a-copy').click();" class="mt-2 mt-sm-0 btn2 btn btn-small btn-outline-primary"><i class="fa fa-files-o"></i> Copiar </a>
            </div>
        </div>
    <?php endif; ?>
</form>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-light bg-light navbar-expand-lg" style="background: linear-gradient(to left, #99ccff 0%, #ccffcc 100%);">
        ...
        <div class="navbar-nav float-rightd ml-auto">
            <?php if (!FM_READONLY): ?>
                <li class="nav-item"><a class="nav-link mx-1" title="Search" href="javascript:showSearch('<?php echo urlencode(FM_PATH) ?>')"><i class="fa fa-search fa-fw"></i> Buscar</a></li>
            <li class="nav-item"><a class="nav-link mx-1" title="Upload files" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload fa-fw" aria-hidden="true"></i> Enviar Arquivo</a></li>
                <li class="nav-item"><a class="nav-link mx-1" title="New folder" href style="outline: none;" data-toggle="modal" data-target="#createNewItem"><i class="fa fa-plus-square fa-fw"></i> Novo Item</a></li>
                <li class="nav-item"><a href="?toggleTree=true" class="nav-link mx-1" title="Toggle Directories List"><i class="fa fa-eye-slash fa-fw"></i> Mudar Vizualização</a></li>
            <?php endif; ?>
            <?php if (FM_USE_AUTH): ?><li class="nav-item"><a class="nav-link ml-1" title="Logout" href="?logout=1"><i class="fa fa-sign-out fa-fw" aria-hidden="true"></i> Sair</a></li><?php endif; ?>
        </div>
        </div>
    </nav>
    <?php
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-plus-square fa-fw"></i> Criar Novo Item</h5>
                ...
                <div class="modal-body">
                    <p>
                        <label for="newfile">Tipo do Item &nbsp; : </label>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline1" name="newfile" value="file" class="custom-control-input">
                        <label class="custom-control-label" for="customRadioInline1">Arquivo</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline2" name="newfile" value="folder" class="custom-control-input" checked>
                        <label class="custom-control-label" for="customRadioInline2">Pasta</label>
                    </div><br><br>

                        <label for="newfilename">Nome do Item : </label>
                ...
                <div class="modal-footer">
                    <button type="submit" name="submit" value="Create Now" onclick="newfolder('<?php echo fm_enc(FM_PATH) ?>');return false;" class="btn btn-success"><i class="fa fa-plus-square fa-fw"></i> Criar Agora</button>
...
<!--    </div>-->
    ...
    <div class="modal" tabindex="-1" role="dialog" id="searchResult">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-search fa-fw"></i> Procurar Arquivos e Pastas</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
